...
_TARGET_DIR = '/home/xychen/projects/def-wangcs/xychen/data/fewshot/datasets/imagenet'
...
# - http://www.image-net.org/data/ILSVRC/2012/ILSVRC2012_img_train.tar
# - http://www.image-net.org/data/ILSVRC/2012/ILSVRC2012_img_val.tar
    url = "http://www.image-net.org/data/ILSVRC/2012/ILSVRC2012_img_train.tar"
    download(url, path=_TARGET_DIR, overwrite=False, sha1_hash=_TRAIN_TAR_SHA1)
    url = "http://www.image-net.org/data/ILSVRC/2012/ILSVRC2012_img_val.tar"
    download(url, path=_TARGET_DIR, overwrite=False, sha1_hash=_VAL_TAR_SHA1)
