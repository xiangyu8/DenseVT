...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None, dct_status = False):
        super().__init__()
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.patch_embed = PatchEmbed(
                img_size=img_size, patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim, dct_status = dct_status,
    ...
    def forward(self, x):
        ...
        # SUP
        pool = self.avgpool(x_last.transpose(1, 2).contiguous())  # [B, C, 1]
