...
class PatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, overlap = 0.0):
        super().__init__()
        ...
        self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size*int(1-overlap))
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
                 ...
                 drop_path_rate=0., norm_layer=nn.LayerNorm,dct_status = False, attn_status = False, overlap = 0.0, **kwargs):
        super().__init__()
        self.is_memory_efficient = kwargs["is_memory_efficient"] if "is_memory_efficient" in kwargs else False
        self.num_features = self.embed_dim = embed_dim

        if dct_status:
            num_patches = img_size[0]**2
            ...
            self.patch_embed = PatchEmbed(
                img_size=img_size[0], patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim, overlap = overlap)
...
def deit_small(patch_size=16, img_size=[224], pretrained=False, num_classes = 0, dct_status = False, in_chans = 3, attn_status = False,overlap = 0.0, **kwargs):
    model = VisionTransformer(img_size=img_size,num_classes = num_classes,
        patch_size=patch_size, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4,
        qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), dct_status = dct_status, in_chans = in_chans, attn_status =attn_status, overlap = overlap,**kwargs)
    if pretrained:
