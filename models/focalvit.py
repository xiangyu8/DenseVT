...
#from .TripletAttention import TripletAttention as Attn 
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(224, 224), patch_size=4, in_chans=3, embed_dim=96, use_conv_embed=False, norm_layer=None, use_pre_norm=False, is_stem=False, dct_status = False):
        super().__init__()
...
class FocalTransformer(nn.Module):
    ...
    def __init__(self, 
        ...
        self.patch_embed = PatchEmbed(
            ...
            use_conv_embed=use_conv_embed, is_stem=True,dct_status = dct_status, 
...
def focal_tiny(img_size = 224, num_classes = 1000, in_chans = 3, dct_status = False, attn_status = False, patch_size = 4):
    return FocalTransformer(img_size = img_size, in_chans = in_chans, num_classes = num_classes,
            embed_dim = 96, depths = [2,2,6,2], drop_path_rate=0.2, patch_size = patch_size,
            focal_levels=[2,2,2,2], expand_sizes=[3,3,3,3], expand_layer="all",
            num_heads=[3,6,12,24], focal_windows=[7,5,3,1], window_size=7,use_conv_embed=True, use_shift=False,
            dct_status =dct_status, attn_status = attn_status) 
